...
<script setup lang="ts">
  ...
  async function zoneItemSelect(item: CiamsZoneDTO.Overview.Find.Result) {
    ...
    await classifyAnalysisComprehensiveStore.setOverview({
      zoneNo: item.zoneNo,
    })
  ...
  function clear() {
    classifyAnalysisComprehensiveStore.clear()
    uitVectorLayer2.clear()
  }
  ...
  onMounted(async () => {
    ...
    await classifyAnalysisComprehensiveStore.setTagList('AR0400')
