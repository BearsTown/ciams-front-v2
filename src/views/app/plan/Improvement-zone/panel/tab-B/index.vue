...
<script setup lang="ts">
  ...
  import Temp from '@/components/app/plan/Improvement-zone/panel/tab-A/temp.vue'
  ...
  import {
    Menu3Sub3TabBTabIdType,
    useMenu3Sub3TabBStore,
  } from '@/stores/app/plan/Improvement-zone/tab-B'
