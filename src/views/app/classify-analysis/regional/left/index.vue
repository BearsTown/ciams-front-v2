...
<script setup lang="ts">
  ...
  const state = classifyAnalysisRegionalStore.state
  ...
  async function zoneItemSelect(item: CiamsZoneDTO.Search.Row) {
    ...
    await classifyAnalysisRegionalStore.setOverview({
      zoneNo: item.zoneNo,
    })
  ...
  function clear() {
    classifyAnalysisRegionalStore.clear()
    uitVectorLayer2.clear()
  }
  ...
  onMounted(async () => {
    ...
    await classifyAnalysisRegionalStore.setTagList('AR0200')
