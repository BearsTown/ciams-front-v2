<template>
  <div class="detail">
    ...
    >
      <el-tab-pane
        v-for="data in menu1_2_2Store.years"
        :label="`${data.title}`"
        :name="data.id"
        :key="data.id"
    ...
    <div class="top">
      <div style="display: flex; padding-bottom: 5px">
        ...
        <el-switch
          size="small"
          v-model="menu1_2_2Store.layerVisible"
          :disabled="!menu1_2_2Store.getSelectDetail()"
        />
      </div>
...
<script setup lang="ts">
  ...
  const filteredTableData = computed(() => {
    // return menu1_2_2Store.getSelectDetail()?.tableData
    return menu1_2_2Store.getSelectDetail()?.tableData?.filter((row) => row.visible)
  })

  const filteredChartData = computed(() => {
    return menu1_2_2Store.getSelectDetail()?.chartData
  ...
  function tabChangeListener(year) {
    ...
    menu1_2_2Store.updateYear(year)
  }
  ...
  //   const selectedDetail = menu1_2_2Store.getSelectDetail()
  //   if (selectedDetail) {
