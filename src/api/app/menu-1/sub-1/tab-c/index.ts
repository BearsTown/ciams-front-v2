      ...
      switch (params.type) {
        case '선도산업':
          resolve({
            ...
            memo: [
              '김천시의 선도산업은 전체 38개 중 제조업이 23개이며, 제조업 관련 서비스업이 15개 업종으로 합성고무  및 플라스틱 물질 제조업, 플라스틱제품 제조업, 전구 및 조명장치 제조업, 전기업은 전반적으로 지수가 높고, 종사자수가 많은 업종으로 ',
        ...
        case '신흥산업':
          resolve({
            ...
            memo: [
              '김천시의 신흥산업은 전체 44개 중 제조업이 17개이며, 제조업 관련 서비스업이 27개 업종이며, 고용성장률과 지역할당 효과가 높은 제조업종은 직물직조 및 직물제품 제조업, 1차 비철금속 제조업, 구조용 금속제품, 탱크 및 증기발생기 제조업, ',
        ...
        case '쇠퇴산업':
          resolve({
            ...
            memo: [
              '김천시의 쇠퇴산업은 전체 34개 중 제조업이 21개이며, 제조업 관련 서비스업이 13개 업종이며, 고용성장률과 지역할당효과가 낮은 업종에는 방적 및 가공사 제조업, 가죽, 가방 및 유사제품 제조업, 비료, 농약 및 살균, 살충제 제조업, 컴퓨터 및 ',
        ...
        case '초기반산업':
          resolve({
            ...
            memo: [
              '김천시의 초기반산업은 전체 23개 중 제조업 20개, 제조업 관련 서비스업이 3개 업종이며, LQ지수가 높은 업종에는 담배제조업, 화학섬유 제조업, 철도장비 제조업, 전구 및 조명장치 제조업 등이 있으며, 현재 김천시 산업을 이끌어가고 있는 주',
