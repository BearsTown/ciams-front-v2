import { computed, markRaw, reactive, Ref, ref, shallowRef } from 'vue'
...
export const useMenu1_2_3Store = defineStore('useMenu1-2-3Store', () => {
  ...
  async function init() {
    ...
    // state.mapWrap = await mapStore.getMapInstance()
  ...
  async function callChangeYear() {
    ...
    selectDetail!.tableData = dataUtil.calculateRatios(data, state.attributes, { round: 1 })
