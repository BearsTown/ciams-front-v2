...
<script setup lang="ts">
  ...
  async function zoneItemSelect(item: CiamsZoneDTO.Search.Row) {
    ...
    await classifyAnalysisITAStore.setOverview({
      zoneNo: item.zoneNo,
    })
    ...
    await classifyAnalysisITAStore.callSelectZone(item.zoneNo)
  }

  function clear() {
    classifyAnalysisITAStore.clear()
    uitVectorLayer2.clear()
  }
  ...
  onMounted(async () => {
    ...
    await classifyAnalysisITAStore.setTagList('AR0100')
