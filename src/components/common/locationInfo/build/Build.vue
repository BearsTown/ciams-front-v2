...
<script setup lang="ts">
  ...
  import KrasInfo from '@/components/common/locationInfo/build/KrasInfo.vue'
  import KgeoInfo from '@/components/common/locationInfo/build/KgeoInfo.vue'
  import PublicInfo from '@/components/common/locationInfo/build/PublicInfo.vue'
