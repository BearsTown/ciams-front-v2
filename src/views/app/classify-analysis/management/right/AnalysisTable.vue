            ...
            <div class="container">
                ...
                <thead>
                  <tr>
                    ...
                    >
                      ...
                      {{ state.overview?.locala === '양호' ? '관리형' : '정비형' }} 지역
                    </th>
                    <th>행정구역(소재지)</th>
                    <td colspan="2">{{ state.overview?.name }}</td>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                  ...
                  <tr>
                    <th>공업지역 유형화</th>
                    <td>{{ state.overview?.fresult }}</td>
                    <th>ITA 분석 결과</th>
                    <td>{{ state.overview?.itaResult }}</td>
                  </tr>
                </tbody>
              </table>
              ...
              <table class="customTable" style="table-layout: fixed; width: 100%">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>도로율</td>
                    <td>{{ `${state.state.overview?.roadRate}%` }}</td>
