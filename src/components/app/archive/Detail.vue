  ...
  <div class="content detail">
    <div class="customCard">
      <div class="customCard-header">
        <p class="title">{{ detailArchvieData.title }}</p>
        <div class="right">
          <span>
            <svg
          ...
          <span>
            ...
            {{ detailArchvieData.regDate?.split('.')[0] }}
          </span>
        </div>
      </div>
      ...
      <button type="button" class="btn-list" @click="goBack">목록</button>
    </div>
  </div>
</template>
